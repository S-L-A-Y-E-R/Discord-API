...
const conversationRoutes_1 = __importDefault(
  require("./routes/conversationRoutes")
);
const socketIo_1 = __importDefault(require("./utils/socketIo"));
const messageRoutes_1 = __importDefault(require("./routes/messageRoutes"));
const directMessagesRoutes_1 = __importDefault(
  require("./routes/directMessagesRoutes")
);
...
app.all("*", (req, res, next) => {
  next(
    new appError_1.default(`Can't find ${req.originalUrl} on this server!`, 404)
  );
});
